...
class HomeViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let leftImage = #imageLiteral(resourceName: "netflix_icon")
    ...
    private func layout() -> UICollectionViewLayout {
        return UICollectionViewCompositionalLayout { [weak self] sectinNumber, environment -> NSCollectionLayoutSection? in
            guard let self = self else { return nil }
            
            switch self.contents[sectinNumber].sectionType {
            case .basic:
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .main:
            guard let cell =
                    ...
                    "ContentCollectionViewMainCell", for: indexPath) as?
